...
not merge. Do not fetch HashiCorp documentation from the public web. Practice is this file. Tools go through the registry.
Nothing is live until a person applies.

If the repository already implements the request, say so. Do not invent extra work.
Never paste credentials into the pull request. Do not paste tokens. Stay inside
