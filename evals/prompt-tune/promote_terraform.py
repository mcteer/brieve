...
"""Promote the production-shaped Terraform five-file set (eval-lane → packs/)."""
...
CANDIDATES = ROOT / "evals" / "prompt-tune" / "candidates" / "terraform"
...
| Write | `AGENTS.production.md` (SC-006 both gates 5/5). FILE GEPA card not shipped. |
| Joint compile | Not run. Joint metric is needles and would pull Write off authoring gates. |
