...
Rows **E1–E24** (hermetic unless marked), plus live legs **EL1–EL3**. Blocking from the moment
...
| Row | Asserts |
| --- | --- |
| E6 | A sync records what it took, its identity, when, and who triggered it (FR-017) |
...
| E14 | Adoption flips the answering content for the NEXT question and is recorded with who and when; declining or ignoring changes nothing (SC-014) |
...
| Row | Asserts |
| --- | --- |
| E18 | A question only customer documents answer is answered, citations resolving against the synced copy by the same check the pin uses (FR-008, SC-001) |
