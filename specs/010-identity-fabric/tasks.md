...
- [ ] T029 [P] [US2] [GATE:conformance] Enclave row in `tests/conformance/identity/test_scope_from_claims.py` (SC-004): two users, two roles, measurably different authority — via the hybrid fabric (T010a), user scope real, carrying the `HYBRID` transitional marker
