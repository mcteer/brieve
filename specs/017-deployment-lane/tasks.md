...
Phase 2 (Foundational)   T004–T007 [P] → T007a → T008 → T008a
                         T009 → T010 → T011 → T012, T013, T014 → T015 → T015b → T015c → T015a → T016
                             ↓
        ┌────────────────────┼────────────────────┐
        ↓                    ↓                    ↓
