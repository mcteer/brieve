...
public web. Practice is this file and the pinned skills `terraform-style-guide` /
...
Never paste credentials into the pull request. Do not paste credentials.
Point at variables.tf for required variables.
